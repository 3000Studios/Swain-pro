        ...
        <div className="flip-front" aria-hidden={isActive}>
          ...
          <div
            ...
            style={{
              ...
              inset: 0,
              background:
                'linear-gradient(180deg, rgba(11,11,11,0.12) 0%, rgba(11,11,11,0.42) 58%, rgba(11,11,11,0.68) 100%)',
              pointerEvents: 'none',
              zIndex: 1,
            }}
          />
        ...
        <div className="flip-back" aria-hidden={!isActive}>
          ...
          {!videoFailed && (
            <video
              ...
              style={{
                ...
                objectFit: 'cover',
                borderRadius: 'inherit',
                opacity: videoLoaded ? (hasPromo ? 0.96 : 0.8) : 0,
          ...
          <div
            style={{
              ...
              borderRadius: 'inherit',
              background:
                'linear-gradient(to top, rgba(11,11,11,0.97) 0%, rgba(11,11,11,0.65) 40%, rgba(11,11,11,0.15) 100%)',
              pointerEvents: 'none',
            }}
          />
